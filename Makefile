...
FORK_URL := ${ARBI_RPC_URL} #ARBI_RPC_URL
...
test-single :; forge test -vv --fork-url ${FORK_URL} --etherscan-api-key ${ETHERSCAN_API_KEY} --match-test testVaultShutdownCanWithdraw